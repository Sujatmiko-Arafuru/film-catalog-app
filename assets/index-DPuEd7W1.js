var F=o=>{throw TypeError(o)};var I=(o,e,t)=>e.has(o)||F("Cannot "+t);var d=(o,e,t)=>(I(o,e,"read from private field"),t?t.call(o):e.get(o)),y=(o,e,t)=>e.has(o)?F("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),E=(o,e,t,i)=>(I(o,e,"write to private field"),i?i.call(o,t):e.set(o,t),t),h=(o,e,t)=>(I(o,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}})();const U="modulepreload",N=function(o){return"/film-catalog-app/"+o},B={},O=function(e,t,i){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));a=Promise.allSettled(t.map(l=>{if(l=N(l),l in B)return;B[l]=!0;const c=l.endsWith(".css"),A=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${A}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":U,c||(p.as="script"),p.crossOrigin="",p.href=l,r&&p.setAttribute("nonce",r),document.head.appendChild(p),c)return new Promise((R,$)=>{p.addEventListener("load",R),p.addEventListener("error",()=>$(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(s){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s}return a.then(s=>{for(const r of s||[])r.status==="rejected"&&n(r.reason);return e().catch(n)})},v={BASE_URL:"https://story-api.dicoding.dev/v1",API_KEY:"",VAPID_PUBLIC_KEY:"BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk"},q=Object.freeze(Object.defineProperty({__proto__:null,default:v},Symbol.toStringTag,{value:"Module"}));class x{static async getStories(){const e=localStorage.getItem("auth-token")||v.API_KEY,t=await fetch(`${v.BASE_URL}/stories?location=1`,{headers:{Authorization:`Bearer ${e}`}}),i=await t.json();if(!t.ok||i.error)throw new Error(i.message||"gagal ambil data");return i.listStory||[]}static async addStory(e){const t=localStorage.getItem("auth-token"),i=t?`${v.BASE_URL}/stories`:`${v.BASE_URL}/stories/guest`,a=t?{Authorization:`Bearer ${t}`}:void 0,n=new FormData,s=e.get("description"),r=e.get("photo"),l=e.get("lat"),c=e.get("lon");s&&n.append("description",s),r&&n.append("photo",r),l!=null&&n.append("lat",l),c!=null&&n.append("lon",c);const p=await(await fetch(i,{method:"POST",headers:a,body:n})).json();if(p.error)throw new Error(p.message||"gagal tambah story");return this.notifyDataChange(),{error:!1,message:"Story berhasil ditambahkan!"}}static createStoryFromFormData(e){const t=e.get("name")||"Story Baru",i=e.get("description")||"Deskripsi story",a=parseFloat(e.get("lat"))||-6.2,n=parseFloat(e.get("lon"))||106.816666,s=e.get("photo");let r="https://via.placeholder.com/300x200/667eea/ffffff?text=Story+Baru";return s&&(r=URL.createObjectURL(s)),{id:"story-"+Date.now(),name:t,description:i,photoUrl:r,createdAt:new Date().toISOString(),lat:a,lon:n}}static async getStoryDetail(e){const i=(await this.getStories()).find(a=>a.id===e);if(!i)throw new Error("story tidak ditemukan");return i}static notifyDataChange(){window.dispatchEvent(new CustomEvent("storiesUpdated"))}static async getFilms(){return this.getStories()}static async addFilm(e){return this.addStory(e)}static async getFilmDetail(e){return this.getStoryDetail(e)}}const P=()=>new Promise((o,e)=>{const t=indexedDB.open("film-favorites-db",1);t.onupgradeneeded=()=>{const i=t.result;i.objectStoreNames.contains("favorites")||i.createObjectStore("favorites",{keyPath:"id"})},t.onsuccess=()=>o(t.result),t.onerror=()=>e(t.error)}),j=async o=>{const e=await P();await new Promise((t,i)=>{const a=e.transaction("favorites","readwrite");a.objectStore("favorites").put(o),a.oncomplete=()=>t(),a.onerror=()=>i(a.error)})},S=async()=>{const o=await P();return await new Promise((e,t)=>{const a=o.transaction("favorites","readonly").objectStore("favorites").getAll();a.onsuccess=()=>e(a.result||[]),a.onerror=()=>t(a.error)})},M=async o=>{const e=await P();await new Promise((t,i)=>{const a=e.transaction("favorites","readwrite");a.objectStore("favorites").delete(o),a.oncomplete=()=>t(),a.onerror=()=>i(a.error)})};function _(o){const e="=".repeat((4-o.length%4)%4),t=(o+e).replace(/-/g,"+").replace(/_/g,"/"),i=atob(t),a=new Uint8Array(i.length);for(let n=0;n<i.length;++n)a[n]=i.charCodeAt(n);return a}class H{constructor(){this.films=[]}async render(){return console.log("Rendering home page..."),`
    ...
    `).join(""),e.querySelectorAll(".film-card").forEach(a=>{a.addEventListener("click",()=>{window.location.hash="#/map"}),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),window.location.hash="#/map")})}),e.querySelectorAll(".fav-btn").forEach(a=>{a.addEventListener("click",async n=>{n.stopPropagation();const s=a.dataset.id,r=this.films.find(c=>c.id===s);(await S()).find(c=>c.id===s)?(await M(s),a.textContent="Simpan Favorit"):(await j(r),a.textContent="Hapus Favorit")})})}showError(e){const t=document.getElementById("films-container");t&&(t.innerHTML=`<div class="error-message">${e}</div>`)}}class z{async render(){console.log("AboutPage render called - FORCE RENDER");const e=`
      <div class="container">
    ...
    `).join(""),e.querySelectorAll(".del-fav").forEach(i=>{i.addEventListener("click",async()=>{await M(i.dataset.id),await this.afterRender()})})}}const f={"/":new H,"/map":new K,"/add":new W,"/about":new z,"/login":new G,"/register":new V,"/favorites":new Y};function J(){return location.hash.replace("#","")||"/"}function X(){const o=J();return o==="/"||o===""?"/":o}var u,k,g,b,m,T,C,Z,w,D;class Q{constructor({navigationDrawer:e,drawerButton:t,content:i}){y(this,m);y(this,u,null);y(this,k,null);y(this,g,null);y(this,b,null);E(this,u,i),E(this,k,t),E(this,g,e),h(this,m,T).call(this),h(this,m,C).call(this)}async renderPage(){const e=X(),t=f[e];if(console.log("Current URL:",location.hash),console.log("Parsed route:",e),console.log("Found page:",t),console.log("Available routes:",Object.keys(f)),e==="/about"){console.log("FORCING ABOUT PAGE RENDER"),h(this,m,w).call(this,e);const a=f["/about"];if(a){const n=await a.render();console.log("About page content length:",n.length),d(this,u).innerHTML=n,await a.afterRender(),console.log("About page rendered successfully");return}}if(e==="/map"){console.log("FORCING MAP PAGE RENDER"),h(this,m,w).call(this,e);const a=f["/map"];if(a){const n=await a.render();console.log("Map page content length:",n.length),d(this,u).innerHTML=n,await a.afterRender(),console.log("Map page rendered successfully");return}}if(e==="/add"){console.log("FORCING ADD PAGE RENDER"),h(this,m,w).call(this,e);const a=f["/add"];if(a){const n=await a.render();console.log("Add page content length:",n.length),d(this,u).innerHTML=n,await a.afterRender(),console.log("Add page rendered successfully");return}}if(e==="/"){console.log("FORCING HOME PAGE RENDER"),h(this,m,w).call(this,e);const a=f["/"];if(a){const n=await a.render();console.log("Home page content length:",n.length),d(this,u).innerHTML=n,await a.afterRender(),console.log("Home page rendered successfully");return}}if(!t){console.error("Page not found for route:",e);const a=f["/"];a&&(d(this,u).innerHTML=await a.render(),await a.afterRender());return}h(this,m,w).call(this,e),await h(this,m,D).call(this,async()=>{console.log("Rendering page for route:",e);const a=await t.render();console.log("Page content length:",a.length),d(this,u).innerHTML=a,d(this,b)&&d(this,b).cleanup&&d(this,b).cleanup(),E(this,b,t),await t.afterRender()});const i=document.getElementById("main-content");i&&i.focus()}}u=new WeakMap,k=new WeakMap,g=new WeakMap,b=new WeakMap,m=new WeakSet,T=function(){d(this,k).addEventListener("click",()=>{d(this,g).classList.toggle("open")}),document.body.addEventListener("click",e=>{!d(this,g).contains(e.target)&&!d(this,k).contains(e.target)&&d(this,g).classList.remove("open"),d(this,g).querySelectorAll("a").forEach(t=>{t.contains(e.target)&&d(this,g).classList.remove("open")})})},C=function(){document.addEventListener("keydown",e=>{if(e.altKey&&e.key==="s"){e.preventDefault();const t=document.getElementById("main-content");t&&(t.focus(),t.scrollIntoView())}if(e.altKey)switch(e.key){case"1":e.preventDefault(),window.location.hash="#/";break;case"2":e.preventDefault(),window.location.hash="#/map";break;case"3":e.preventDefault(),window.location.hash="#/add";break;case"4":e.preventDefault(),window.location.hash="#/about";break}})},Z=function(e){return`
    ...
    `,!document.querySelector("#install-animation-style")){const i=document.createElement("style");i.id="install-animation-style",i.textContent=`
      ...
      `,document.head.appendChild(i)}document.body.appendChild(t),document.getElementById("install-button").addEventListener("click",async()=>{if(this.deferredPrompt){this.deferredPrompt.prompt();const{outcome:i}=await this.deferredPrompt.userChoice;console.log(`user choice: ${i}`),this.deferredPrompt=null,this.hideInstallButton()}}),document.getElementById("dismiss-button").addEventListener("click",()=>{this.hideInstallButton(),localStorage.setItem("install-prompt-dismissed","true")})}hideInstallButton(){const e=document.getElementById("install-banner");e&&(e.style.animation="slideDown 0.3s ease-out",setTimeout(()=>e.remove(),300))}}class ae{constructor(){this.init()}init(){window.addEventListener("offline",()=>{this.showOfflineIndicator()}),window.addEventListener("online",()=>{this.hideOfflineIndicator(),this.showOnlineNotification()}),navigator.onLine||this.showOfflineIndicator()}showOfflineIndicator(){if(document.getElementById("offline-indicator"))return;const e=document.createElement("div");if(e.id="offline-indicator",e.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    `,!document.querySelector("#sw-update-animation-style")){const t=document.createElement("style");t.id="sw-update-animation-style",t.textContent=`
      ...
      `,document.head.appendChild(t)}document.body.appendChild(e),document.getElementById("reload-button").addEventListener("click",()=>{window.location.reload()}),document.getElementById("later-button").addEventListener("click",()=>{this.hideUpdatePrompt()})}hideUpdatePrompt(){const e=document.getElementById("sw-update-prompt");e&&(e.style.animation="slideDown 0.3s ease-out",setTimeout(()=>e.remove(),300))}}document.addEventListener("DOMContentLoaded",async()=>{console.log("app starting...");try{new te,new ae,new ie;const o=new Q({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")}),e=document.getElementById("login-link"),t=()=>{const i=localStorage.getItem("auth-token");e&&(i?(e.textContent="Logout",e.href="#/",e.onclick=a=>{a.preventDefault(),localStorage.removeItem("auth-token"),t()}):(e.textContent="Login",e.href="#/login",e.onclick=null))};if(t(),console.log("rendering page..."),await o.renderPage(),window.addEventListener("hashchange",async()=>{console.log("page changed"),await o.renderPage();const i=localStorage.getItem("auth-token"),a=document.getElementById("login-link");a&&(a.textContent=i?"Logout":"Login")}),console.log("app ready"),"serviceWorker"in navigator)try{const i=await navigator.serviceWorker.ready;console.log("sw ready:",i.scope),localStorage.getItem("push-subscribed")||setTimeout(async()=>{await ee.subscribe()&&console.log("push notif subscribed")},2e3)}catch(i){console.warn("sw error:",i)}}catch(o){console.error("error starting app:",o)}});
